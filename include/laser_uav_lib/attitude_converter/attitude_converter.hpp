#ifndef ATTITUDE_CONVERTER_HPP
#define ATTITUDE_CONVERTER_HPP
...
namespace laser_uav_lib
{
     ...
     * as: tf2::Quaternion tf1_quaternion = AttitudeConverter(roll, pitch, yaw); All the default Euler angles are in the extrinsic RPY notation.
     */
    ...
    public:
         ...
         *
         * @param quaternion tf2::Quaternion quaternion
         */
        ...
        /**
         * @brief laser_uav_lib::EulerAttitude constructor
         *
         * @param euler_attitude laser_uav_lib::EulerAttitude
         */
        AttitudeConverter(const laser_uav_lib::EulerAttitude &euler_attitude);
...
template <>
struct std::tuple_size<laser_uav_lib::AttitudeConverter>
{
    static constexpr int value = 3;
};

template <>
struct std::tuple_element<0, laser_uav_lib::AttitudeConverter>
{
    using type = double;
};

template <>
struct std::tuple_element<1, laser_uav_lib::AttitudeConverter>
{
    using type = double;
};

template <>
struct std::tuple_element<2, laser_uav_lib::AttitudeConverter>
{
    using type = double;
};
